    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (searchTerm != null) {
            val callback = object : retrofit2.Callback<GitHubSearchResult> {
                ...
                override fun onResponse(call: retrofit2.Call<GitHubSearchResult>?, response: Response<GitHubSearchResult>?) {
                ...
                override fun onFailure(call: retrofit2.Call<GitHubSearchResult>?, t: Throwable) {
                    println("Not working :(")
                }
            }
            ...
            val callback = object : retrofit2.Callback<List<Repo>> {
                ...
                override fun onResponse(call: retrofit2.Call<List<Repo>>?, response: Response<List<Repo>>?) {
